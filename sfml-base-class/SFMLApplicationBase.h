...
struct SFMLApplicationSettings {
	...
	//bool enableFixedTimeStep = DEFAULT_ENABLE_FIXED_TIME_STEP;
...
private:
	...
	//static constexpr bool DEFAULT_ENABLE_FIXED_TIME_STEP = false;
	static constexpr float DEFAULT_FIXED_TIME_STEP = 0.5f / DEFAULT_FPS; // By default, the application will be updated twice as fast as it is rendered
